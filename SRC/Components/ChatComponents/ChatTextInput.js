...
function ChatTextInput({placeholder}) {
    return (
        ...
        <View style={styles.textContainer}>
            ...
            <TouchableOpacity>
                <MaterialCommunityIcons name={'microphone'} size={25} color={defaultStyles.colors.medium} style={styles.icon}/>
            </TouchableOpacity>
            
        </View>
        <View style={styles.button}>
        <TouchableOpacity>
            <MaterialCommunityIcons name="send" size={30} color={defaultStyles.colors.white} style={{alignSelf:'center'}}/>
        </TouchableOpacity>
        </View>
        </View>
